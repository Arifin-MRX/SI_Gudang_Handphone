            ...
            <div class="row   flex-wrap mt-4 ">
                <div class="col-md-6 col-lg-3 m-4  ">
                    <div class="border border-primary p-3 bg-primary bg-opacity-10 rounded shadow-lg ">
                        ...
                        <div class="icon">
                            <p class="fs-1 ">
                                <span class="p-3">100</span><i class="fa-solid fa-truck align-self-end "
                ...
                <div class="col-md-6 col-lg-3 m-4  ">
                    <div class="border border-primary p-3 bg-primary bg-opacity-10 rounded shadow-lg ">
                        ...
                        <div class="icon">
                            <p class="fs-1 ">
                                <span class="p-3">100</span><i class="bi bi-clipboard2-check-fill align-self-end "
                                    style="color: #89919f;"></i>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3 m-4  ">
                    <div class="border border-primary p-3 bg-primary bg-opacity-10 rounded shadow-lg ">
                        ...
                        <div class="icon">
                            <p class="fs-1 ">
                                <span class="p-3">100</span><i class="bi bi-clipboard2-x-fill align-self-end "
                                    style="color: #89919f;"></i>
                            </p>
                        </div>
                    </div>
